      ...
      <div>
        ...
        >
          {currentPosts.map((post: any) => (
            <Link
              href={getPostUrl(post)} // ✅ FIX DI SINI
              key={post._id}
              style={{
                display: "flex",
                gap: "25px",
            ...
            >
              ...
              >
                <img
                  src={
                    post.image ||
                    "https://via.placeholder.com/300/200?text=Inspirasi"
                  }
                  alt={post.title}
                  style={{
                    width: "100%",
              ...
              >
                <span
                  style={{
                    fontSize: "11px",
                    color: getCategoryColor(post.categorySlug), // ✅ FIX
                    fontWeight: "800",
                    textTransform: "uppercase",
                    letterSpacing: "1px",
                  }}
                >
                  {post.category || post.categorySlug || "Inspirasi"}
                </span>
                ...
                >
                  ...
                  <span
                    style={{ color: "#B294D1", fontWeight: "bold" }}
                  >
            ...
            {[...Array(totalPages)].map((_, i) => (
              <button
                ...
                style={{
                  ...
                  border: "1px solid #f0eaf5",
                  backgroundColor:
                    currentPage === i + 1 ? "#5D427C" : "#fff",
                  color:
                    currentPage === i + 1 ? "#fff" : "#5D427C",
                  cursor: "pointer",
                  fontWeight: "800",
                }}
              >
